...
const DetailCardFaqManagementRegister = () => {
                    ...
                    {btnList.map((item, index) => {
                      ...
                      return (
                        <React.Fragment key={item.id}>
                          ...
                          {/* 두 번째 컬럼: Select */}
                          <div className={`col-span-3 px-[8px] py-[6px] flex items-center justify-start text-[14px] font-medium text-black bg-white border-r ${borderClass} border-tb-br-color`}>
                            {item.isSelect ? (
                              <Select
                                key={index}
                          ...
                          <div className={`col-span-4 px-[8px] py-[6px] flex items-center justify-start text-[14px] font-medium text-black bg-white ${borderClass} border-tb-br-color`}>
                            {item.isDetailInput ? (
                              <Input
...
export default DetailCardFaqManagementRegister;